...
class RandomPathMatchingGraphBuilder(MatchingGraphBuilderBase):
    def __init__(self, src_graphs, src_labels, tar_graphs, tar_labels, mg_creation_alpha, cross_class, label_name, attribute_names,
                 node_ins_c, node_del_c, edge_ins_c, edge_del_c, node_subst_fct, dataset_name, nbr_mgs_to_create = 1):
...
def build_mg_from_pair_para(pair_seed_zip, graph_class, nbr_mgs_to_create, mg_creation_alpha, label_name, attribute_names):
    ...
    edit_path,_,_ = calculate_ged(src_gr,tar_gr,mg_creation_alpha,label_name, attribute_names)
